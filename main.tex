...
\begin{abstract}
A rigourous but intuitive approach to analysis in Euclidean Spaces is undertaken, aiming to study some standard results in multivariable differential analysis, measure theory and calculus on smooth manifolds with an inclination to deduce and prove by self. Some interesting and unexpected applications of the said are then explored as a natural development of the underlying theoretical ideas.
\end{abstract}
